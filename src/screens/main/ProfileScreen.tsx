				...
				{error ? (
					<View className="mt-16 items-center">
						<Ionicons
							...
							color="#9CA3AF"
						/>
						<Text className="text-base font-bold text-gray-400 dark:text-gray-500 mt-3">
					...
					<View className="mt-10 items-center">
						...
						<View className="flex-row gap-3 mt-8">
							{[1, 2, 3].map((i) => (
								<View
									key={i}
									className="flex-1 h-24 rounded-2xl bg-gray-200 dark:bg-[#2A2A2A]"
								/>
							))}
						</View>
						<View className="flex-row gap-3 mt-4">
							{[1, 2, 3].map((i) => (
								<View
									key={i}
									className="flex-1 h-20 rounded-2xl bg-gray-200 dark:bg-[#2A2A2A]"
								/>
							))}
						</View>
					</View>
					...
					<View>
						...
						>
							...
							<TouchableOpacity
								...
								onPress={handlePhoneVerificationPress}
								activeOpacity={0.7}
							>
						...
						{driverProfile && (
							...
							>
								{[
									...
									{
										icon: 'wallet',
										value: `${Number(balance).toLocaleString('pt-AO')} Kz`,
										label: 'Saldo',
										color: themeColors.primary,
									},
								].map((item, i) => (
									...
									>
										...
										/>
										<Text
											className="text-base font-black text-secondary dark:text-off-white mt-2"
											numberOfLines={1}
								...
								{quickLinks.map((link, i) => (
									...
									>
										...
										>
											...
											<Text className="text-sm font-black text-secondary dark:text-off-white">
												{link.label}
											</Text>
										</TouchableOpacity>
									</Animated.View>
						...
						{driverProfile && (
							...
							>
								...
								>
									<View
										className={`w-11 h-11 rounded-xl items-center justify-center ${complianceStatus === 'APPROVED' ? 'bg-green-500/20' : 'bg-amber-500/20'}`}
									>
										<Ionicons
											name={
												complianceStatus === 'APPROVED'
									...
									<TouchableOpacity
										...
										onPress={() => {
											if (
												...
												Alert.alert(
													'Atenção',
													'Preenche o nome e o telefone do contacto de emergência.',
												);
												return;
											}
											...
											<TouchableOpacity
												...
												onPress={() => {
													if (!phoneOtpCode.trim()) {
														Alert.alert(
															'Atenção',
															'Insere o código de verificação.',
														);
														return;
													}
